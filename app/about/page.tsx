...
import { GITHUB_URL, PORTFOLIO_URL } from '@/data/siteLinks'
        ...
        <div className="space-y-3">
          {links.map((link) => (
            <a
              ...
              className="group block rounded-xl border border-aws-border bg-aws-card/60 p-5 transition-all hover:border-c1/40 hover:bg-aws-card"
            >
              <div className="flex items-start gap-4">
                ...
                <div className="min-w-0 flex-1">
                  <div className="flex items-center justify-between gap-3 mb-1">
                    ...
                    <span className="font-space-mono text-[0.6rem] text-aws-muted shrink-0">↗</span>
                  </div>
