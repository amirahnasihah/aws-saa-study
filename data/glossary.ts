export const glossaryCategories: Record<string, string[]> = {
  ...
  'Security Services':  ['Amazon GuardDuty','Amazon Inspector','Amazon Macie','AWS Shield','Amazon Cognito','AWS Directory Service','ACM','ACM Private CA','AWS RAM','CloudHSM'],
  ...
  'IAM & Policies':     ['ARN','Principal','Identity-based policy','Resource-based policy','Key Policy','Source Account','Destination Account','Permissions boundary','Managed policy','Inline policy','Trust policy','Service-Linked Role','Role Chaining','Explicit Deny','Implicit Deny','Session Policy','OU (Organizational Unit)','Permission denied','ABAC','NotPrincipal','Permission Set','Account Assignment'],
