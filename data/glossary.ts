export const glossaryCategories: Record<string, string[]> = {
  ...
  'IAM & Policies':     ['ARN','Principal','Identity-based policy','Resource-based policy','Permissions boundary','Managed policy','Inline policy','Trust policy','Service-Linked Role','Role Chaining','Explicit Deny','Implicit Deny','Session Policy','OU (Organizational Unit)','Permission denied','ABAC','NotPrincipal','Permission Set','Account Assignment'],
