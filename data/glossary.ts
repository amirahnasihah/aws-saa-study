export const glossaryCategories: Record<string, string[]> = {
  ...
  'Cost Management':    ['AWS Cost Explorer','AWS Budgets','Cost and Usage Report','Cost Allocation Tags','Intelligent-Tiering','AWS Compute Optimizer','AWS Trusted Advisor','Consolidated Billing','Budget Actions','Cost Anomaly Detection'],
