        ...
        services: [
          {
            ...
            keywords: ['IaC', 'Infrastructure as Code', 'template', 'stack', 'rollback', 'repeatable deployment', 'Lambda-backed custom resource', 'AMI lookup', 'dynamic parameters', 'multi-region template', 'Mappings', 'Outputs', 'cross-stack reference', 'Fn::ImportValue', 'cfn-init', 'cfn-signal', 'cfn-hup', 'cfn-get-metadata', 'change set', 'drift detection', 'stack rollback', 'DeletionPolicy'],
          },
          {
            shortName: 'SSM',
          ...
          },
          {
            ...
            keywords: ['metrics', 'logs', 'alarms', 'dashboards', 'CPU monitoring', 'custom metrics', 'Log Groups', 'VPC Flow Logs', 'CloudWatch agent', 'unified agent', 'memory utilization', 'detailed monitoring'],
          },
          {
            shortName: 'X-Ray',
            fullName: 'AWS X-Ray',
