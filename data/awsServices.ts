      ...
      },
      {
        ...
        services: [
          ...
          },
          {
            ...
            keywords: ['dedicated HSM', 'FIPS 140-2 Level 3', 'customer control', 'single-tenant', 'hardware security', 'TDE', 'Oracle RDS', 'Transparent Data Encryption'],
          },
        ],
      },
      {
    ...
    sections: [
      {
        ...
        services: [
          ...
          },
          {
            ...
            keywords: ['MySQL compatible', 'PostgreSQL compatible', '6 copies', '3 AZs', 'auto storage 128TB', 'fast failover', '15 read replicas', 'Global Database', 'cross-region DR', 'RTO 1 min', 'RPO 1s'],
          },
          {
        ...
        services: [
          {
            ...
            keywords: ['queue', 'decouple', 'async', 'pull-based', 'visibility timeout', 'FIFO', 'DLQ', 'at-least-once', 'queue policy', 'cross-account SQS', 'resource-based policy'],
          },
          {
            shortName: 'SNS',
          ...
          },
          {
            ...
            keywords: ['REST API', 'WebSocket', 'API management', 'throttling', 'mapping templates', 'backward compatibility', 'VTL', 'response transformation'],
          },
          {
      ...
      },
      {
        ...
        services: [
          ...
          },
          {
            ...
            keywords: ['distributed tracing', 'service map', 'latency analysis', 'microservices', 'Lambda tracing', 'bottleneck', 'debugging', 'SQS tracing', 'end-to-end trace', 'bottleneck detection'],
          },
        ],
      },
      {
        ...
        services: [
          ...
          },
          {
            ...
            tips: [
              ...
              'Rekognition + Kinesis VIDEO Streams = real-time video analysis (e.g. CCTV face mask detection)',
              'Rekognition + Kinesis DATA Streams = SALAH untuk video. Data Streams untuk text/structured records',
              'Textract vs Comprehend: Textract = extract text FROM documents. Comprehend = analyze/understand text content',
              'Exam shortcut: "read quiz questions aloud" → Polly. "CCTV face detection" → Rekognition + Kinesis Video Streams. "Chatbot" → Lex',
            ],
            keywords: ['Polly', 'Transcribe', 'Lex', 'Rekognition', 'Comprehend', 'Textract', 'Kinesis Video Streams', 'text-to-speech', 'speech-to-text', 'chatbot', 'image analysis'],
          },
        ],
      },
    ],
        ...
        services: [
          {
            ...
            tips: [
              'ElastiCache for Redis: sub-millisecond latency, key-value + data structures (lists, sets, sorted sets)',
            ...
            keywords: ['Redis', 'Memcached', 'in-memory', 'reduce DB load', 'caching', 'sub-millisecond', 'leaderboards', 'session store'],
          },
          {
