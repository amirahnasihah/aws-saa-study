...
export const domains: DomainData[] = [
  ...
  BATCH -->|"Perlu kawal OS/GPU,<br/>fleet steady murah"| E["🖥️ EC2 / ASG<br/>(kau urus)"]`,
            ...
            keywords: ['AWS Batch', 'batch computing', 'long-running job', 'managed', 'job queue', 'job definition', 'compute environment', 'EC2 fleet', 'Fargate', 'Spot', 'run to completion', 'replace third-party', 'pricing', 'job storage', 'EFS shared data', 'FSx for Lustre', 'scratch storage'],
          },
          {
            shortName: 'Fargate',
