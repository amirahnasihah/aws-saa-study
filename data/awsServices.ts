      ...
      },
      {
        ...
        services: [
          ...
          },
          {
            ...
            keywords: ['Polly', 'Transcribe', 'Lex', 'Rekognition', 'Comprehend', 'Textract', 'Kinesis Video Streams', 'text-to-speech', 'speech-to-text', 'chatbot', 'image analysis', 'StartSpeechSynthesisTask', 'audiobook', 'OCR'],
          },
          {
            shortName: 'SageMaker',
