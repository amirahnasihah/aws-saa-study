...
export const domains: DomainData[] = [
  ...
  PS --> A3["🏢 AWS Account C"]`,
          ...
          },
          {
            ...
            perangkap: [{"soalan": "Security team nak jalankan penetration test pada EC2 & RDS production. Apa langkah pertama yang DIPERLUKAN?", "umpan": "Buka AWS Support case / minta kelulusan AWS dulu sebelum mula. Nampak betul sebab 'ini infra AWS, mesti kena izin'. SALAH: AWS dah PRE-AUTHORIZE 8 service ni termasuk EC2 & RDS — tak perlu approval.", "betul": "Terus pentest — EC2 & RDS antara 8 service pre-authorized. Keyword 'pentest 8 permitted services' = no prior approval needed."}, {"soalan": "Pasukan nak uji ketahanan app dengan simulate DDoS volumetrik pada ALB mereka sendiri. Boleh terus buat?", "umpan": "Boleh, sebab ia resource sendiri dan pentest dibenarkan. Nampak betul sebab 'resource saya'. SALAH: DoS/DDoS simulation DILARANG di bawah AUP walaupun atas resource sendiri.", "betul": "Tak boleh terus — DDoS simulation prohibited; kena engage AWS DDoS Simulation Testing program. Keyword 'DDoS/flooding' = prohibited activity."}],
